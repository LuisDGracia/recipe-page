import { InstructionsContainer, InstructionsList, Text } from "./InstructionsStyled";
	...
	return (
		<InstructionsContainer>
			...
			<InstructionsList>
				...
				<li>
					<Text>
						<strong>Make the crust:</strong>Using a food processor, pulse the graham
				...
				<li>
					<Text>
						<strong>Make the filling:</strong>Using a handheld or stand mixer fitted
				...
				<li>
					<Text>
						<strong>Prepare the simple water bath (see note)</strong>Boil a pot of
